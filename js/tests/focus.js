...
const WORDS={
  Red:   {en:'RED',   es:'ROJO',     pt:'VERMELHO', fr:'ROUGE', de:'ROT', it:'ROSSO', nl:'ROOD', pl:'CZERWONY', ru:'КРАСНЫЙ', tr:'KIRMIZI', ro:'ROȘU', sv:'RÖD', da:'RØD', no:'RØD', fi:'PUNAINEN', id:'MERAH', uk:'ЧЕРВОНИЙ', bg:'ЧЕРВЕНО', sr:'ЦРВЕНА', mk:'ЦРВЕНА', el:'ΚΟΚΚΙΝΟ', cs:'ČERVENÁ', hr:'CRVENA', sk:'ČERVENÁ', sl:'RDEČA', hu:'PIROS', lt:'RAUDONA', lv:'SARKANS', et:'PUNANE', ar:'أحمر', he:'אדום', fa:'قرمز', hi:'लाल', ja:'あか'},
  Blue:  {en:'BLUE',  es:'AZUL',     pt:'AZUL',     fr:'BLEU',  de:'BLAU', it:'BLU', nl:'BLAUW', pl:'NIEBIESKI', ru:'СИНИЙ', tr:'MAVİ', ro:'ALBASTRU', sv:'BLÅ', da:'BLÅ', no:'BLÅ', fi:'SININEN', id:'BIRU', uk:'СИНІЙ', bg:'СИНЬО', sr:'ПЛАВА', mk:'СИНА', el:'ΜΠΛΕ', cs:'MODRÁ', hr:'PLAVA', sk:'MODRÁ', sl:'MODRA', hu:'KÉK', lt:'MĖLYNA', lv:'ZILS', et:'SININE', ar:'أزرق', he:'כחול', fa:'آبی', hi:'नीला', ja:'あお'},
  Green: {en:'GREEN', es:'VERDE',    pt:'VERDE',     fr:'VERT',  de:'GRÜN', it:'VERDE', nl:'GROEN', pl:'ZIELONY', ru:'ЗЕЛЁНЫЙ', tr:'YEŞİL', ro:'VERDE', sv:'GRÖN', da:'GRØN', no:'GRØNN', fi:'VIHREÄ', id:'HIJAU', uk:'ЗЕЛЕНИЙ', bg:'ЗЕЛЕНО', sr:'ЗЕЛЕНА', mk:'ЗЕЛЕНА', el:'ΠΡΑΣΙΝΟ', cs:'ZELENÁ', hr:'ZELENA', sk:'ZELENÁ', sl:'ZELENA', hu:'ZÖLD', lt:'ŽALIA', lv:'ZAĻŠ', et:'ROHELINE', ar:'أخضر', he:'ירוק', fa:'سبز', hi:'हरा', ja:'みどり'},
  Yellow:{en:'YELLOW',es:'AMARILLO', pt:'AMARELO',   fr:'JAUNE', de:'GELB', it:'GIALLO', nl:'GEEL', pl:'ŻÓŁTY', ru:'ЖЁЛТЫЙ', tr:'SARI', ro:'GALBEN', sv:'GUL', da:'GUL', no:'GUL', fi:'KELTAINEN', id:'KUNING', uk:'ЖОВТИЙ', bg:'ЖЪЛТО', sr:'ЖУТА', mk:'ЖОЛТА', el:'ΚΙΤΡΙΝΟ', cs:'ŽLUTÁ', hr:'ŽUTA', sk:'ŽLTÁ', sl:'RUMENA', hu:'SÁRGA', lt:'GELTONA', lv:'DZELTENS', et:'KOLLANE', ar:'أصفر', he:'צהוב', fa:'زرد', hi:'पीला', ja:'きいろ'},
  Purple:{en:'PURPLE',es:'PÚRPURA',  pt:'ROXO',      fr:'VIOLET',de:'LILA', it:'VIOLA', nl:'PAARS', pl:'FIOLETOWY', ru:'ФИОЛЕТОВЫЙ', tr:'MOR', ro:'MOV', sv:'LILA', da:'LILLA', no:'LILLA', fi:'VIOLETTI', id:'UNGU', uk:'ФІОЛЕТОВИЙ', bg:'ЛИЛАВО', sr:'ЉУБИЧАСТА', mk:'ВИОЛЕТОВА', el:'ΜΟΒ', cs:'FIALOVÁ', hr:'LJUBIČASTA', sk:'FIALOVÁ', sl:'VIJOLIČNA', hu:'LILA', lt:'VIOLETINĖ', lv:'VIOLETS', et:'LILLA', ar:'بنفسجي', he:'סגול', fa:'بنفش', hi:'बैंगनी', ja:'むらさき'},
};
