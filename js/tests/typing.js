...
const PASSAGES={
  ...
  ms:[
    "Memori kerja ialah keupayaan menyimpan sedikit maklumat dalam fikiran dan menggunakannya serta-merta. Kebanyakan orang dewasa hanya mampu menyimpan kira-kira tujuh digit pada satu masa.",
    "Kesan Stroop muncul apabila nama sesuatu warna dicetak dengan dakwat berlainan warna. Otak membaca perkataan lebih pantas daripada mengenal pasti warna, jadi tindak balas anda menjadi sedikit perlahan.",
    "Kelajuan menaip biasanya diukur dalam perkataan seminit. Penaip yang mahir mencapai kira-kira empat puluh perkataan, manakala penaip profesional boleh melebihi tujuh puluh perkataan.",
    "Model Big Five menggambarkan personaliti melalui lima dimensi luas: keterbukaan, kehematan, ekstraversi, keramahan dan neurotisisme. Inilah rangka kerja yang paling banyak dikaji.",
    "Masa tindak balas purata manusia terhadap isyarat visual mudah adalah kira-kira dua ratus lima puluh milisaat. Keletihan dan usia kedua-duanya meningkatkan angka tersebut.",
    "Kecerdasan cair ialah keupayaan menyelesaikan masalah baharu tanpa bergantung pada pengetahuan yang dipelajari. Ujian matriks mengukur keupayaan ini dengan agak berkesan.",
    "Kira-kira lapan peratus lelaki mempunyai sejenis kekurangan penglihatan warna, manakala kadar dalam kalangan wanita jauh lebih rendah, hanya sekitar setengah peratus penduduk.",
    "Kecerdasan emosi merangkumi empat cabang: mengesan, menggunakan, memahami dan mengurus emosi. Ini antara kemahiran yang paling ketara boleh dilatih.",
  ],
  tl:[
    "Ang working memory ay ang kakayahang magtago ng kaunting impormasyon sa isip at gamitin ito agad. Karamihan sa mga nasa hustong gulang ay nakakapagtago lamang ng humigit-kumulang pitong digit nang sabay-sabay.",
    "Lumilitaw ang Stroop effect kapag ang pangalan ng isang kulay ay nakaimprenta sa ibang kulay ng tinta. Mas mabilis bumasa ng salita ang utak kaysa kumilala ng kulay, kaya bumabagal nang bahagya ang iyong pagtugon.",
    "Ang bilis ng pag-type ay karaniwang sinusukat sa bilang ng salita bawat minuto. Ang bihasang tagatipa ay umaabot sa apatnapung salita, habang ang propesyonal ay maaaring humigit sa pitumpu.",
    "Inilalarawan ng Big Five ang personalidad sa limang malawak na dimensyon: pagkabukas, pagkamaingat, pagkapalabas, pagkamagiliw at pagkabalisa. Ito ang pinakapinag-aralang balangkas.",
    "Ang karaniwang oras ng pagtugon ng tao sa simpleng biswal na senyas ay nasa dalawang daan at limampung milisegundo. Parehong nagpapataas nito ang pagod at edad.",
    "Ang fluid intelligence ay ang kakayahang lutasin ang bagong suliranin nang hindi umaasa sa natutunang kaalaman. Mahusay itong nasusukat ng mga pagsusulit na matrix.",
    "Mga walong porsiyento ng kalalakihan ang may ilang anyo ng kakulangan sa paningin sa kulay, samantalang mas mababa ito sa kababaihan, mga kalahating porsiyento lamang ng populasyon.",
    "Ang emosyonal na katalinuhan ay binubuo ng apat na sangay: pagkilala, paggamit, pag-unawa at pamamahala ng emosyon. Isa ito sa mga kasanayang pinakamadaling sanayin.",
  ],
  af:[
    "Werkgeheue is die vermoë om 'n klein hoeveelheid inligting in jou kop te hou en dit onmiddellik te gebruik. Die meeste volwassenes kan slegs omtrent sewe syfers gelyktydig behou.",
    "Die Stroop-effek verskyn wanneer die naam van 'n kleur in 'n ander kleur ink gedruk word. Die brein lees woorde vinniger as wat dit kleure herken, dus vertraag jou reaksie effens.",
    "Tikspoed word gewoonlik gemeet in woorde per minuut. 'n Vaardige tikker haal ongeveer veertig woorde, terwyl 'n professionele tikker sewentig woorde kan oorskry.",
    "Die Groot Vyf-model beskryf persoonlikheid deur vyf breë dimensies: openheid, pligsgetrouheid, ekstroversie, inskiklikheid en neurotisisme. Dit is die mees bestudeerde raamwerk.",
    "Die gemiddelde menslike reaksietyd op 'n eenvoudige visuele sein is ongeveer tweehonderd en vyftig millisekondes. Moegheid en ouderdom laat hierdie syfer albei styg.",
    "Vloeibare intelligensie is die vermoë om nuwe probleme op te los sonder om op aangeleerde kennis te steun. Matrikstoetse meet hierdie vermoë redelik doeltreffend.",
    "Ongeveer agt persent van mans het 'n vorm van kleursiggebrek, terwyl die syfer onder vroue veel laer is, slegs omtrent 'n halwe persent van die bevolking.",
    "Emosionele intelligensie bestaan uit vier takke: waarneming, gebruik, begrip en bestuur van emosies. Dit is een van die mees oefenbare vaardighede wat bestaan.",
  ],
  sq:[
    "Kujtesa e punës është aftësia për të mbajtur një sasi të vogël informacioni në mendje dhe për ta përdorur menjëherë. Shumica e të rriturve mbajnë vetëm rreth shtatë shifra njëkohësisht.",
    "Efekti Stroop shfaqet kur emri i një ngjyre shtypet me bojë të një ngjyre tjetër. Truri i lexon fjalët më shpejt sesa njeh ngjyrat, prandaj reagimi juaj ngadalësohet paksa.",
    "Shpejtësia e shkrimit matet zakonisht në fjalë për minutë. Një shkrues i aftë arrin rreth dyzet fjalë, ndërsa një profesionist mund të kalojë shtatëdhjetë fjalë.",
    "Modeli Big Five e përshkruan personalitetin përmes pesë dimensioneve të gjera: hapja, ndërgjegjshmëria, ekstraversioni, pajtueshmëria dhe neuroticizmi. Kjo është korniza më e studiuar.",
    "Koha mesatare e reagimit të njeriut ndaj një sinjali të thjeshtë vizual është rreth dyqind e pesëdhjetë milisekonda. Lodhja dhe mosha e rrisin këtë shifër.",
    "Inteligjenca fluide është aftësia për të zgjidhur probleme të reja pa u mbështetur në njohuri të mësuara. Testet me matrica e masin këtë aftësi mjaft mirë.",
    "Rreth tetë përqind e burrave kanë një formë të mangësisë së shikimit të ngjyrave, ndërsa shifra te gratë është shumë më e ulët, vetëm rreth gjysmë përqind e popullsisë.",
    "Inteligjenca emocionale përbëhet nga katër degë: perceptimi, përdorimi, kuptimi dhe menaxhimi i emocioneve. Kjo është një nga aftësitë më të stërvitshme që ekziston.",
  ],
  sw:[
    "Kumbukumbu ya kazi ni uwezo wa kuhifadhi kiasi kidogo cha taarifa akilini na kukitumia mara moja. Watu wazima wengi huhifadhi tu takriban tarakimu saba kwa wakati mmoja.",
    "Athari ya Stroop hutokea pale jina la rangi linapochapishwa kwa wino wa rangi tofauti. Ubongo husoma maneno haraka kuliko kutambua rangi, hivyo mwitikio wako hupungua kidogo.",
    "Kasi ya kuandika hupimwa kwa maneno kwa dakika. Mwandishi mahiri hufikia takriban maneno arobaini, huku mtaalamu akiweza kuzidi maneno sabini.",
    "Muundo wa Big Five huelezea utu kupitia vipimo vitano vipana: uwazi, uangalifu, ujamii, ukubalifu na wasiwasi. Huu ndio mfumo uliochunguzwa zaidi.",
    "Muda wa wastani wa mwitikio wa binadamu kwa ishara rahisi ya kuona ni takriban milisekunde mia mbili na hamsini. Uchovu na umri vyote huongeza idadi hiyo.",
    "Akili tendaji ni uwezo wa kutatua matatizo mapya bila kutegemea maarifa yaliyojifunzwa. Majaribio ya matriki hupima uwezo huu kwa ufanisi mzuri.",
    "Takriban asilimia nane ya wanaume wana aina fulani ya upungufu wa uoni wa rangi, huku idadi kwa wanawake ikiwa ndogo zaidi, takriban nusu asilimia ya watu.",
    "Akili ya hisia inajumuisha matawi manne: kutambua, kutumia, kuelewa na kudhibiti hisia. Huu ni miongoni mwa ujuzi unaoweza kufunzwa zaidi.",
  ],
  th:[
    "ความจำใช้งานคือความสามารถในการเก็บข้อมูลจำนวนเล็กน้อยไว้ในใจแล้วนำมาใช้ทันที ผู้ใหญ่ส่วนใหญ่เก็บตัวเลขได้เพียงราวเจ็ดหลักในเวลาเดียวกัน",
    "ปรากฏการณ์สทรูปเกิดขึ้นเมื่อชื่อของสีถูกพิมพ์ด้วยหมึกที่เป็นสีอื่น สมองอ่านคำได้เร็วกว่าการระบุสี การตอบสนองของคุณจึงช้าลงเล็กน้อย",
    "ความเร็วในการพิมพ์มักวัดเป็นจำนวนคำต่อนาที ผู้ที่พิมพ์คล่องทำได้ราวสี่สิบคำ ขณะที่มืออาชีพอาจทำได้เกินเจ็ดสิบคำ",
    "แบบจำลองห้าองค์ประกอบอธิบายบุคลิกภาพผ่านมิติกว้างห้าด้าน ได้แก่ การเปิดรับประสบการณ์ ความมีสติรอบคอบ การแสดงตัว ความประนีประนอม และความไม่มั่นคงทางอารมณ์",
    "เวลาตอบสนองเฉลี่ยของมนุษย์ต่อสัญญาณทางสายตาอย่างง่ายอยู่ที่ราวสองร้อยห้าสิบมิลลิวินาที ทั้งความเหนื่อยล้าและอายุล้วนทำให้ตัวเลขนี้สูงขึ้น",
    "สติปัญญาแบบลื่นไหลคือความสามารถในการแก้ปัญหาใหม่โดยไม่พึ่งพาความรู้ที่เรียนมา แบบทดสอบเมทริกซ์วัดความสามารถนี้ได้ค่อนข้างดี",
    "ผู้ชายราวแปดเปอร์เซ็นต์มีภาวะบกพร่องในการมองเห็นสีบางรูปแบบ ขณะที่สัดส่วนในผู้หญิงต่ำกว่ามาก คือราวครึ่งเปอร์เซ็นต์ของประชากร",
    "ความฉลาดทางอารมณ์ประกอบด้วยสี่แขนง ได้แก่ การรับรู้ การใช้ การเข้าใจ และการจัดการอารมณ์ นี่คือหนึ่งในทักษะที่ฝึกฝนได้ชัดเจนที่สุด",
  ],
  ko:[
    "작업 기억은 적은 양의 정보를 머릿속에 잠시 담아 두고 곧바로 사용하는 능력을 말한다. 대부분의 성인은 한 번에 일곱 자리 정도의 숫자만 안정적으로 유지할 수 있다고 알려져 있다.",
    "스트룹 효과는 색을 가리키는 낱말이 다른 색의 잉크로 인쇄되었을 때 나타난다. 뇌는 색을 알아보는 것보다 글자를 훨씬 빨리 읽기 때문에 반응이 조금씩 느려지게 된다.",
    "타자 속도는 보통 분당 낱말 수로 측정하며 낱말 하나를 다섯 글자로 계산한다. 능숙한 사람은 마흔 낱말 정도를 치고 전문 타자수는 일흔 낱말을 넘기기도 한다.",
    "다섯 요인 모형은 개방성과 성실성, 외향성, 우호성, 신경성이라는 다섯 가지 넓은 차원으로 성격을 설명한다. 심리학에서 가장 많이 연구되고 반복 검증된 틀이다.",
    "단순한 시각 신호에 대한 사람의 평균 반응 시간은 대략 이백오십 밀리초 안팎으로 알려져 있다. 피로와 나이는 물론 화면의 지연 시간도 이 수치를 높이는 요인이다.",
    "유동 지능은 이미 배운 지식에 기대지 않고 처음 보는 문제를 풀어내는 능력을 뜻한다. 행렬 형태의 과제는 이 능력을 비교적 효과적으로 측정하는 방법으로 쓰인다.",
    "남성의 약 팔 퍼센트가 어떤 형태로든 색각 이상을 가지고 있는 반면 여성의 비율은 훨씬 낮아서 전체 인구의 대략 반 퍼센트 정도에 그치는 것으로 보고되어 있다.",
    "감성 지능은 감정을 인식하고 활용하고 이해하고 관리하는 네 가지 갈래로 이루어져 있다. 꾸준한 훈련을 통해 가장 뚜렷하게 향상되는 능력 가운데 하나로 꼽힌다.",
  ],
  zh:[
    "工作记忆是指把少量信息暂时保存在脑中并立即加以使用的能力。大多数成年人一次只能稳定地记住大约七位数字，这一限度在很长时间里都被视为人类认知加工的基本容量，也被写进了许多教科书。",
    "斯特鲁普效应出现在表示颜色的词语被印成另一种颜色的时候。大脑读取文字的速度快于辨认颜色，因此人的反应会略微变慢，这一现象在各种实验条件下都非常稳定，很难通过意志力完全消除。",
    "打字速度通常以每分钟词数来衡量，其中一个词按五个字符计算。熟练的打字者大约能达到四十词，而经过系统训练的专业打字员往往可以超过七十词，竞技选手甚至能突破一百二十词的水平。",
    "五因素模型通过开放性、尽责性、外向性、宜人性和神经质这五个宽泛的维度来描述人格。它是心理学中被研究得最多、也被重复验证得最为充分的一个框架，在不同文化中都相当稳定。",
    "人对简单视觉信号的平均反应时间大约为两百五十毫秒。疲劳和年龄都会让这一数值上升，屏幕本身的延迟、测试时的环境光线以及一天中的不同时段，同样会对最终结果产生影响。",
    "流体智力是指不依赖既有知识去解决全新问题的能力。矩阵类的题目能够比较有效地测量这种能力，因此在跨文化的心理学研究中被长期广泛采用，也较少受到语言和教育背景的干扰。",
    "大约百分之八的男性存在某种形式的色觉缺陷，而女性中的比例要低得多，仅占人口的百分之零点五左右。这一显著差异与相关基因位于性染色体上的遗传方式有着直接的关系。",
    "情绪智力包含四个分支，分别是感知情绪、运用情绪、理解情绪和管理情绪。它被认为是最能够通过刻意训练获得明显提升的心理能力之一，与团队协作和领导力评价都有稳定的关联。",
  ],
};
